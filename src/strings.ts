...
export const projects = `
  ...
  WebCheckers: 
  An online version of Checkers created using Java with a Freemarker UI. Play checkers with friends or an AI. One of my first major projects that showcases how far I've come as an engineer.
  https://github.com/HershNagpal/webcheckers
  `

export const welcome = `Welcome!

  This is my website. It's currently under construction, being rebuilt using TypeScript.
